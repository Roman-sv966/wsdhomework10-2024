...
@pytest.fixture
def manager_token():
    return create_access_token(data={"sub": "manager", "role": UserRole.MANAGER.value})
...
def login_request_data():
    return {"username": "john_doe_123","email":"john.doe@gmail.com", "password": "SecurePassword123!"}